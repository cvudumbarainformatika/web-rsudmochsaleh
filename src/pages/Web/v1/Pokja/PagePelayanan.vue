<template>
  <q-page class="pokja-page-container">
      ...
      >
        ...
        <div class="content-box">
          ...
          >
            ...
            <p class="text-slate-400 text-xs max-w-sm q-mt-xs q-mx-auto">Detail dokumen atau informasi untuk program Pokja ini belum dipublikasikan.</p>
          </div>
...
// Dynamic medical/security icons for Pokja
const defaultIcons = [
  'verified_user',
  'health_and_safety',
